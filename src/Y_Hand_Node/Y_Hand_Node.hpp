...
public:
     ...
     int create_objects(
        ...
        if(hardware_init("install/devices_pkg/share/devices_pkg/YAML/Y_Hand/out/TOP.yaml", dev_config) != 0)
        {
...
private:
    void topic_callback(const devices_pkg::msg::YHandMsg::SharedPtr msg) const
    {
        ...
        Motor15_Control->Get_Motor_FB_Data( Motor15_Device,  &mu_this->sendMes.motors[14].pos,  &mu_this->sendMes.motors[14].vel,  &mu_this->sendMes.motors[14].tor, &mu_this->sendMes.motors[14].temp[0], &mu_this->sendMes.motors[14].error);
        Motor16_Control->Get_Motor_FB_Data( Motor16_Device,  &mu_this->sendMes.motors[15].pos,  &mu_this->sendMes.motors[15].vel,  &mu_this->sendMes.motors[15].tor, &mu_this->sendMes.motors[15].temp[0], &mu_this->sendMes.motors[15].error);
        Motor17_Control->Get_Motor_FB_Data( Motor17_Device,  &mu_this->sendMes.motors[16].pos,  &mu_this->sendMes.motors[16].vel,  &mu_this->sendMes.motors[16].tor, &mu_this->sendMes.motors[16].temp[0], &mu_this->sendMes.motors[16].error);
        Motor18_Control->Get_Motor_FB_Data( Motor18_Device,  &mu_this->sendMes.motors[17].pos,  &mu_this->sendMes.motors[17].vel,  &mu_this->sendMes.motors[17].tor, &mu_this->sendMes.motors[17].temp[0], &mu_this->sendMes.motors[17].error);
        Motor19_Control->Get_Motor_FB_Data( Motor19_Device,  &mu_this->sendMes.motors[18].pos,  &mu_this->sendMes.motors[18].vel,  &mu_this->sendMes.motors[18].tor, &mu_this->sendMes.motors[18].temp[0], &mu_this->sendMes.motors[18].error);
        Motor20_Control->Get_Motor_FB_Data( Motor20_Device,  &mu_this->sendMes.motors[19].pos,  &mu_this->sendMes.motors[19].vel,  &mu_this->sendMes.motors[19].tor, &mu_this->sendMes.motors[19].temp[0], &mu_this->sendMes.motors[19].error);
        Motor21_Control->Get_Motor_FB_Data( Motor21_Device,  &mu_this->sendMes.motors[20].pos,  &mu_this->sendMes.motors[20].vel,  &mu_this->sendMes.motors[20].tor, &mu_this->sendMes.motors[20].temp[0], &mu_this->sendMes.motors[20].error);
        Motor22_Control->Get_Motor_FB_Data( Motor22_Device,  &mu_this->sendMes.motors[21].pos,  &mu_this->sendMes.motors[21].vel,  &mu_this->sendMes.motors[21].tor, &mu_this->sendMes.motors[21].temp[0], &mu_this->sendMes.motors[21].error);
        Motor23_Control->Get_Motor_FB_Data( Motor23_Device,  &mu_this->sendMes.motors[22].pos,  &mu_this->sendMes.motors[22].vel,  &mu_this->sendMes.motors[22].tor, &mu_this->sendMes.motors[22].temp[0], &mu_this->sendMes.motors[22].error);
        Motor24_Control->Get_Motor_FB_Data( Motor24_Device,  &mu_this->sendMes.motors[23].pos,  &mu_this->sendMes.motors[23].vel,  &mu_this->sendMes.motors[23].tor, &mu_this->sendMes.motors[23].temp[0], &mu_this->sendMes.motors[23].error);
        Motor25_Control->Get_Motor_FB_Data( Motor25_Device,  &mu_this->sendMes.motors[24].pos,  &mu_this->sendMes.motors[24].vel,  &mu_this->sendMes.motors[24].tor, &mu_this->sendMes.motors[24].temp[0], &mu_this->sendMes.motors[24].error);
        Motor26_Control->Get_Motor_FB_Data( Motor26_Device,  &mu_this->sendMes.motors[25].pos,  &mu_this->sendMes.motors[25].vel,  &mu_this->sendMes.motors[25].tor, &mu_this->sendMes.motors[25].temp[0], &mu_this->sendMes.motors[25].error);
        Motor27_Control->Get_Motor_FB_Data( Motor27_Device,  &mu_this->sendMes.motors[26].pos,  &mu_this->sendMes.motors[26].vel,  &mu_this->sendMes.motors[26].tor, &mu_this->sendMes.motors[26].temp[0], &mu_this->sendMes.motors[26].error);
        Motor28_Control->Get_Motor_FB_Data( Motor28_Device,  &mu_this->sendMes.motors[27].pos,  &mu_this->sendMes.motors[27].vel,  &mu_this->sendMes.motors[27].tor, &mu_this->sendMes.motors[27].temp[0], &mu_this->sendMes.motors[27].error);
